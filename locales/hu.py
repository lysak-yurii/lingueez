...
TRANSLATIONS: dict[str, str] = {
    ...
    "Tag these words…": "Szavak címkézése…",
    "Show less": "Kevesebb",
    "Show all {count}": "Mind a {count} megjelenítése",
    ...
    "Starting on login is turned off for Lingueez in Windows Settings, so it can't be switched on here.": "A bejelentkezéskori indítás ki van kapcsolva a Lingueez számára a Windows beállításaiban, ezért itt nem kapcsolható be.",
    "Open Windows startup settings": "Windows indítási beállítások megnyitása",
    "Windows did not apply this change. You can turn Lingueez on or off yourself under Settings > Apps > Startup.": "A Windows nem alkalmazta ezt a módosítást. A Lingueezt saját kezűleg kapcsolhatja be vagy ki a Beállítások > Alkalmazások > Indítás menüpontban.",
    ...
    "for {word} in {language}": "ehhez: {word}, nyelv: {language}",
    "Add definition": "Meghatározás hozzáadása",
    ...
    "New definition — keep it or restore the previous one?": "Új meghatározás — megtartja, vagy visszaállítja az előzőt?",
    "Keep new": "Új megtartása",
    "Keep old": "Régi megtartása",
    "Generate Definitions": "Meghatározások generálása",
    "Generate Definitions…": "Meghatározások generálása…",
    "Words selected: {n}": "Kijelölt szavak: {n}",
    "the word's language": "a szó nyelve",
    "the translation's language": "a fordítás nyelve",
    "Skip words that already have one": "Azok a szavak kihagyása, amelyeknek már van",
    "Stopping…": "Leállítás…",
    "Only the first 100 words will be used.": "Csak az első 100 szó lesz felhasználva.",
    "Generated: {generated} · Skipped: {skipped} · Failed: {failed}": "Generálva: {generated} · Kihagyva: {skipped} · Sikertelen: {failed}",
