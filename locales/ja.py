...
TRANSLATIONS: dict[str, str] = {
    ...
    "Starting on login is turned off for Lingueez in Windows Settings, so it can't be switched on here.": "Lingueez のログイン時の起動は Windows の設定でオフになっているため、ここではオンにできません。",
    "Open Windows startup settings": "Windows のスタートアップ設定を開く",
    "Windows did not apply this change. You can turn Lingueez on or off yourself under Settings > Apps > Startup.": "Windows はこの変更を適用しませんでした。設定 > アプリ > スタートアップ で Lingueez のオン/オフを切り替えられます。",
    ...
    "for {word} in {language}": "{word} を {language} で",
    "Add definition": "定義を追加",
    ...
    "Regenerate": "再生成",
    "New definition — keep it or restore the previous one?": "新しい定義 — このまま使いますか、それとも以前のものに戻しますか？",
    "Keep new": "新しい方を使う",
    "Keep old": "以前の方を使う",
    "Generate Definitions": "定義の生成",
    "Generate Definitions…": "定義を生成…",
    "Words selected: {n}": "選択した単語: {n}",
    "the word's language": "単語の言語",
    "the translation's language": "訳語の言語",
    "Skip words that already have one": "既に定義がある単語をスキップ",
    "Stopping…": "停止中…",
    "Only the first 100 words will be used.": "最初の 100 語のみが使用されます。",
    "Generated: {generated} · Skipped: {skipped} · Failed: {failed}": "生成: {generated} · スキップ: {skipped} · 失敗: {failed}",
