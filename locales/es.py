...
TRANSLATIONS: dict[str, str] = {
    ...
    "Tag these words…": "Etiquetar estas palabras…",
    "Show less": "Ver menos",
    "Show all {count}": "Ver las {count}",
    ...
    "for {word} in {language}": "para {word} en {language}",
    ...
    "New definition — keep it or restore the previous one?": "Nueva definición: ¿conservarla o restaurar la anterior?",
    "Keep new": "Conservar nueva",
    "Keep old": "Conservar anterior",
    "Generate Definitions": "Generar definiciones",
    "Generate Definitions…": "Generar definiciones…",
    "Words selected: {n}": "Palabras seleccionadas: {n}",
    "the word's language": "el idioma de la palabra",
    "the translation's language": "el idioma de la traducción",
    "Skip words that already have one": "Omitir palabras que ya tienen una",
    "Stopping…": "Deteniendo…",
    "Only the first 100 words will be used.": "Solo se usarán las primeras 100 palabras.",
    "Generated: {generated} · Skipped: {skipped} · Failed: {failed}": "Generadas: {generated} · Omitidas: {skipped} · Fallidas: {failed}",
