...
TRANSLATIONS: dict[str, str] = {
    ...
    "Search scope…": "Suchbereich…",
    "Nothing to practice yet": "Noch nichts zu üben",
    "Add words to your vocabulary and they show up here.":
        "Fügen Sie Wörter zu Ihrem Wortschatz hinzu — sie erscheinen dann hier.",
    "Come back when cards are due, or practice the newest words now.":
        "Kommen Sie wieder, wenn Karten fällig sind, oder üben Sie jetzt die neuesten Wörter.",
    "Practice newest words": "Neueste Wörter üben",
    "Pick another deck above, or adjust your filters on the Words page.":
        "Wählen Sie oben ein anderes Deck oder passen Sie die Filter auf der Wörter-Seite an.",
    ...
    "Tag these words…": "Diese Wörter taggen…",
    ...
    "Starting on login is turned off for Lingueez in Windows Settings, so it can't be switched on here.": "Der Start bei der Anmeldung ist für Lingueez in den Windows-Einstellungen deaktiviert und kann hier nicht eingeschaltet werden.",
    "Open Windows startup settings": "Windows-Autostarteinstellungen öffnen",
    "Windows did not apply this change. You can turn Lingueez on or off yourself under Settings > Apps > Startup.": "Windows hat diese Änderung nicht übernommen. Sie können Lingueez selbst unter Einstellungen > Apps > Autostart ein- oder ausschalten.",
    ...
    "for {word} in {language}": "für {word} auf {language}",
    "Add definition": "Definition hinzufügen",
    "Add a definition…": "Definition hinzufügen…",
    "Generate on save": "Beim Speichern generieren",
    "Set up an AI key in Settings → Translation & AI to use this": "Richten Sie unter Einstellungen → Übersetzung & KI einen KI-Schlüssel ein, um dies zu nutzen",
    "Select the source language first.": "Bitte wählen Sie zuerst die Quellsprache aus.",
    "The definition in the box will be replaced by a generated one.": "Die Definition im Feld wird durch eine generierte ersetzt.",
    "Definitions on save turned off": "Definitionen beim Speichern deaktiviert",
    "Turned off after {n} failed attempts in a row.": "Nach {n} fehlgeschlagenen Versuchen in Folge deaktiviert.",
    "Definition not generated": "Definition wurde nicht generiert",
    "Regenerate": "Neu generieren",
    "New definition — keep it or restore the previous one?": "Neue Definition — behalten oder die vorherige wiederherstellen?",
    "Keep new": "Neue behalten",
    "Keep old": "Alte behalten",
    "Generate Definitions": "Definitionen generieren",
    "Generate Definitions…": "Definitionen generieren…",
    "Words selected: {n}": "Ausgewählte Wörter: {n}",
    "the word's language": "Sprache des Wortes",
    "the translation's language": "Sprache der Übersetzung",
    "Skip words that already have one": "Wörter überspringen, die bereits eine haben",
    "Stopping…": "Wird angehalten…",
    "Only the first 100 words will be used.": "Nur die ersten 100 Wörter werden verwendet.",
    "Generated: {generated} · Skipped: {skipped} · Failed: {failed}": "Generiert: {generated} · Übersprungen: {skipped} · Fehlgeschlagen: {failed}",
    ...
    "{sandbox} sandbox on Wayland.": (
        ...
        "{sandbox}-Sandbox unter Wayland nicht verfügbar."
    ),
    ...
    "Ignore this word": "Dieses Wort ignorieren",
    "Already ignored.": "Bereits ignoriert.",
    "{count} word(s) won't come up in practice.": "{count} Wort/Wörter kommen beim Üben nicht mehr vor.",
    "'{word}' is back in rotation": "„{word}“ ist wieder im Umlauf",
    "'{word}' won't come up again": "„{word}“ kommt nicht mehr vor",
    "Mark for relearning": "Zum Wiederholen markieren",
    "Forgot this word — move it to To Learn": "Wort vergessen — nach „Zu lernen“ verschieben",
    "'{word}' is queued to learn again": "„{word}“ wird noch einmal gelernt",
    "{count} word(s) queued to learn again.": "{count} Wort/Wörter zum erneuten Lernen vorgemerkt.",
    "Nothing here to relearn yet.": "Hier gibt es noch nichts zum Wiederholen.",
