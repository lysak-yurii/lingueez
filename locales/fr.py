...
TRANSLATIONS: dict[str, str] = {
    ...
    "for {word} in {language}": "pour {word} en {language}",
    "Add definition": "Ajouter une définition",
    "Add a definition…": "Ajoutez une définition…",
    "Generate on save": "Générer à l'enregistrement",
    "Set up an AI key in Settings → Translation & AI to use this": "Configurez une clé d'IA dans Paramètres → Traduction & IA pour utiliser cette option",
    "Select the source language first.": "Veuillez d'abord sélectionner la langue source.",
    "The definition in the box will be replaced by a generated one.": "La définition du champ sera remplacée par une définition générée.",
    "Definitions on save turned off": "Définitions à l'enregistrement désactivées",
    "Turned off after {n} failed attempts in a row.": "Désactivé après {n} échecs consécutifs.",
    "Definition not generated": "Définition non générée",
    "Regenerate": "Régénérer",
    "New definition — keep it or restore the previous one?": "Nouvelle définition — la garder ou restaurer la précédente ?",
    "Keep new": "Garder la nouvelle",
    "Keep old": "Garder l’ancienne",
    "Generate Definitions": "Générer des définitions",
    "Generate Definitions…": "Générer des définitions…",
    "Words selected: {n}": "Mots sélectionnés : {n}",
    "the word's language": "la langue du mot",
    "the translation's language": "la langue de la traduction",
    "Skip words that already have one": "Ignorer les mots qui en ont déjà une",
    "Stopping…": "Arrêt…",
    "Only the first 100 words will be used.": "Seuls les 100 premiers mots seront utilisés.",
    "Generated: {generated} · Skipped: {skipped} · Failed: {failed}": "Générées : {generated} · Ignorées : {skipped} · Échecs : {failed}",
