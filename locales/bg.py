...
TRANSLATIONS: dict[str, str] = {
    ...
    "Tag these words…": "Маркиране на тези думи…",
    "Show less": "Свиване",
    "Show all {count}": "Показване на всички {count}",
    ...
    "for {word} in {language}": "за {word} на език: {language}",
    "Regenerate": "Генерирай отново",
    "New definition — keep it or restore the previous one?": "Нова дефиниция — да се запази ли или да се върне предишната?",
    "Keep new": "Запази новата",
    "Keep old": "Запази старата",
    "Generate Definitions": "Генериране на дефиниции",
    "Generate Definitions…": "Генерирай дефиниции…",
    "Words selected: {n}": "Избрани думи: {n}",
    "the word's language": "езикът на думата",
    "the translation's language": "езикът на превода",
    "Skip words that already have one": "Пропускай думи, които вече имат дефиниция",
    "Stopping…": "Спиране…",
    "Only the first 100 words will be used.": "Ще бъдат използвани само първите 100 думи.",
    "Generated: {generated} · Skipped: {skipped} · Failed: {failed}": "Генерирани: {generated} · Пропуснати: {skipped} · Неуспешни: {failed}",
