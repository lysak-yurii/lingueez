...
TRANSLATIONS: dict[str, str] = {
    ...
    "for {word} in {language}": "pro {word} v jazyce: {language}",
    "Add definition": "Přidat definici",
    "Add a definition…": "Přidejte definici…",
    "Generate on save": "Generovat při uložení",
    "Set up an AI key in Settings → Translation & AI to use this": "Chcete-li to použít, nastavte klíč AI v Nastavení → Překlad a AI",
    "Select the source language first.": "Nejprve vyberte zdrojový jazyk.",
    "The definition in the box will be replaced by a generated one.": "Definice v poli bude nahrazena vygenerovanou.",
    "Definitions on save turned off": "Definice při uložení vypnuty",
    "Turned off after {n} failed attempts in a row.": "Vypnuto po {n} neúspěšných pokusech za sebou.",
    "Definition not generated": "Definice nebyla vygenerována",
    "Regenerate": "Vygenerovat znovu",
    "New definition — keep it or restore the previous one?": "Nová definice — ponechat ji, nebo obnovit předchozí?",
    "Keep new": "Ponechat novou",
    "Keep old": "Ponechat starou",
    "Generate Definitions": "Generování definic",
    "Generate Definitions…": "Generovat definice…",
    "Words selected: {n}": "Vybraná slova: {n}",
    "the word's language": "jazyk slova",
    "the translation's language": "jazyk překladu",
    "Skip words that already have one": "Přeskočit slova, která už definici mají",
    "Stopping…": "Zastavování…",
    "Only the first 100 words will be used.": "Použije se jen prvních 100 slov.",
    "Generated: {generated} · Skipped: {skipped} · Failed: {failed}": "Vygenerováno: {generated} · Přeskočeno: {skipped} · Selhalo: {failed}",
