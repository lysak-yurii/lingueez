...
TRANSLATIONS: dict[str, str] = {
    ...
    "Tag these words…": "Tagg disse ord…",
    ...
    "for {word} in {language}": "for {word} på {language}",
    "Add definition": "Tilføj definition",
    "Add a definition…": "Tilføj en definition…",
    "Generate on save": "Generér ved gem",
    "Set up an AI key in Settings → Translation & AI to use this": "Opsæt en AI-nøgle under Indstillinger → Oversættelse og AI for at bruge dette",
    "Select the source language first.": "Vælg først kildesproget.",
    "The definition in the box will be replaced by a generated one.": "Definitionen i feltet erstattes af en genereret.",
    "Definitions on save turned off": "Definitioner ved gem er slået fra",
    "Turned off after {n} failed attempts in a row.": "Slået fra efter {n} mislykkede forsøg i træk.",
    "Definition not generated": "Definitionen blev ikke genereret",
    "Regenerate": "Generér igen",
    "New definition — keep it or restore the previous one?": "Ny definition — behold den eller gendan den forrige?",
    "Keep new": "Behold ny",
    "Keep old": "Behold gammel",
    "Generate Definitions": "Generér definitioner",
    "Generate Definitions…": "Generér definitioner…",
    "Words selected: {n}": "Valgte ord: {n}",
    "the word's language": "ordets sprog",
    "the translation's language": "oversættelsens sprog",
    "Skip words that already have one": "Spring ord over, der allerede har en",
    "Stopping…": "Stopper…",
    "Only the first 100 words will be used.": "Kun de første 100 ord bruges.",
    "Generated: {generated} · Skipped: {skipped} · Failed: {failed}": "Genereret: {generated} · Sprunget over: {skipped} · Mislykket: {failed}",
