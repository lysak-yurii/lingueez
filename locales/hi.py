...
TRANSLATIONS: dict[str, str] = {
    ...
    "Tag these words…": "इन शब्दों को टैग करें…",
    "Show less": "कम दिखाएँ",
    ...
    "for {word} in {language}": "{word} के लिए, भाषा: {language}",
    "Add definition": "परिभाषा जोड़ें",
    ...
    "New definition — keep it or restore the previous one?": "नई परिभाषा — इसे रखें या पिछली वापस लाएँ?",
    "Keep new": "नई रखें",
    "Keep old": "पुरानी रखें",
    "Generate Definitions": "परिभाषाएँ जनरेट करें",
    "Generate Definitions…": "परिभाषाएँ जनरेट करें…",
    "Words selected: {n}": "चुने गए शब्द: {n}",
    "the word's language": "शब्द की भाषा",
    "the translation's language": "अनुवाद की भाषा",
    "Skip words that already have one": "जिन शब्दों की पहले से परिभाषा है उन्हें छोड़ें",
    "Stopping…": "रोका जा रहा है…",
    "Only the first 100 words will be used.": "केवल पहले 100 शब्द उपयोग किए जाएँगे।",
    "Generated: {generated} · Skipped: {skipped} · Failed: {failed}": "जनरेट: {generated} · छोड़े गए: {skipped} · विफल: {failed}",
