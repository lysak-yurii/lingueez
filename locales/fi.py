...
TRANSLATIONS: dict[str, str] = {
    ...
    "Tag these words…": "Merkitse nämä sanat…",
    "Show less": "Näytä vähemmän",
    "Show all {count}": "Näytä kaikki {count}",
    ...
    "Starting on login is turned off for Lingueez in Windows Settings, so it can't be switched on here.": "Käynnistys kirjautuessa on poistettu käytöstä Lingueezilta Windowsin asetuksissa, joten sitä ei voi ottaa käyttöön täältä.",
    "Open Windows startup settings": "Avaa Windowsin käynnistysasetukset",
    "Windows did not apply this change. You can turn Lingueez on or off yourself under Settings > Apps > Startup.": "Windows ei ottanut muutosta käyttöön. Voit itse ottaa Lingueezin käyttöön tai poistaa sen käytöstä kohdassa Asetukset > Sovellukset > Käynnistys.",
    ...
    "for {word} in {language}": "sanalle {word}, kieli: {language}",
    ...
    "New definition — keep it or restore the previous one?": "Uusi määritelmä — säilytetäänkö se vai palautetaanko edellinen?",
    "Keep new": "Säilytä uusi",
    "Keep old": "Säilytä vanha",
    "Generate Definitions": "Määritelmien luonti",
    "Generate Definitions…": "Luo määritelmät…",
    "Words selected: {n}": "Valittuja sanoja: {n}",
    "the word's language": "sanan kieli",
    "the translation's language": "käännöksen kieli",
    "Skip words that already have one": "Ohita sanat, joilla on jo määritelmä",
    "Stopping…": "Pysäytetään…",
    "Only the first 100 words will be used.": "Vain ensimmäiset 100 sanaa käytetään.",
    "Generated: {generated} · Skipped: {skipped} · Failed: {failed}": "Luotu: {generated} · Ohitettu: {skipped} · Epäonnistui: {failed}",
